...
public abstract class Formatos {
	 ...
	 * @param valor
	 * @return el valor ingresado formateado a porcentaje o vacio en caso de error
	 */
	 ...
	 * @param valor
	 * @return el valor ingresado sin formtato o porcentaje o vacio en caso de error
	 */
	public static String QuitaformatoPorcentaje(String valor){
		if(!valor.trim().isEmpty())
		{
			if(valor.trim().endsWith("%")){
				valor = valor.substring(0,valor.length()-1);
	 ...
	 * @param valor
	 * @return valor con formato pesos y dos decimales o el mismo valor si no comienza con el signo $
	 */
	public static String formatearValorString( String valor){
			...
			if(!valor.startsWith("$")){
				...
				{			
					...
					int decimales = 0;
					if (Configuracion.parametroDecimales == null ||Configuracion.parametroDecimales.isEmpty()) {
						decimales = 0;
					}else{
						decimales = Integer.parseInt(Configuracion.parametroDecimales);
					}
	 ...
	 * @param valor
	 * @return valor sin formato pesos  o el mismo valor si no comienza con el signo $
	 */
	...
	/**
	 * metodo que formatea un String Para Porcentajes, con el numero de decimales pasado por parametro
	 * @param valor
	 ...
	 * @return el valor ingresado sin formtato o porcentaje o vacio en caso de error
	 */
	public static String QuitaformatoPorcentaje(String valor, int numeroDecimales){
		if(!valor.trim().isEmpty())
		{
			if(valor.trim().endsWith("%")){
				valor = valor.substring(0,valor.length()-1);
	...
	/**
	 * metodo que formatea un String Para Factor, con el numero de decimales pasado por parametro
	 * @param valor
	 * @param numeroDecimales
	 * @return el valor ingresado formateado a porcentaje o vacio en caso de error
	 */
	public static String formatearFactorStringStatic(String valor, int numeroDecimales){
		if(!valor.trim().isEmpty())
		{
			if(valor.trim().endsWith("%")){
				valor = valor.substring(0,valor.length()-1);
	 ...
	 * @return el valor ingresado sin formtato o porcentaje o vacio en caso de error
	 */
	public static String QuitaformatoFactorStatic(String valor, int numeroDecimales){
		if(!valor.trim().isEmpty()){
			if(valor.trim().endsWith("%")){
				valor = valor.substring(0,valor.length()-1);
			}
